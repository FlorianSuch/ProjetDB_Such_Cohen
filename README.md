...
Tu travailles dans le domaine du **Sport / Jiu-Jitsu Brésilien (JJB)**.

Ton organisation sportive internationale spécialisée en **Jiu-Jitsu Brésilien** a comme activité principale :

* l’organisation et la gestion de **compétitions officielles nationales et internationales**
* la gestion des **classements des athlètes**
* le suivi des **grades (ceintures)**
* l’affiliation des **clubs**
* l’enregistrement des **résultats sportifs**

C’est une organisation comparable à la :

* **International Brazilian Jiu-Jitsu Federation (IBJJF)**
* **International Judo Federation (IJF)**

qui encadrent et réglementent leur discipline au niveau mondial.
...
Inspire-toi du **site officiel de la International Brazilian Jiu-Jitsu Federation**, notamment des sections relatives aux :
...
Ton organisation sportive souhaite appliquer la méthode **MERISE** afin de concevoir un **système d’information** permettant de gérer efficacement l’ensemble de ces données.

Tu es chargé de la **phase d’analyse**, c’est-à-dire :

> recueillir et formaliser les besoins auprès des responsables de l’organisation.

La description doit correspondre aux informations que fournit **quelqu’un qui connaît le fonctionnement de l’entreprise**, mais **pas comment se construit un système d’information**.
...
Les données doivent être regroupées dans **un tableau**.

Contraintes :

* il doit y avoir **entre 25 et 35 données**
* le dictionnaire sert à fournir **des informations supplémentaires sur chaque donnée**
* il ne doit pas y avoir **d’a priori sur la modélisation future**
...
* Un athlète peut apparaître dans **plusieurs classements**.
